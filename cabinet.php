...
<section class="diagnosis info-room">
    ...
    <div class="message-container">
      <div class="success-message message-box">
        <p>Bildirişiniz yükləndi.</p>
        <button class="message-close">
          <img src="img/btn-close.svg" alt="">
        </button>
      </div>
      <div class="fail-message message-box">
        <p>Bildirişiniz yüklənmədi. [mesajinizdaadfsasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfasdfsadf cox ciddi problemler var]
        </p>
        <script>
            let text = document.querySelector('.fail-message p').innerHTML;
            let removeSpan = text.substring(text.indexOf("["), text.lastIndexOf("]")+1);
            let newText = text.replace(removeSpan , '');
            let newSpan = text.substring(text.indexOf("[")+1, text.lastIndexOf("]"));
            document.querySelector('.fail-message p').innerHTML = newText;
            var span = document.createElement('a');
            span.classList.add('span-message')
            span.textContent = newSpan;
            document.querySelector('.fail-message p').appendChild(span);
        </script>
        <button class="message-close">
          <img src="img/btn-close.svg" alt="">
        </button>
        ...
        <div class="row">
            <div class="new-heading-box">
                <div class="breadcrumbs">
                    ...
                    <span>></span>
                    <p class="current-point">Qəmbər Hüseynov</p>
                </div>
            ...
            <div class="index-main-container w-100">
                <div class="same-big-box">
                    <p class="title-box">Əlavə et</p>
                    <div class="img-box"><img src="img/cloud.png" alt=""></div>
                    <div class="box-btns w-100">
                        <button class="link-box" type="button" data-toggle="modal" data-target="#diagnosis">Diaqnoz</button>
                        <button class="link-box" type="button" data-toggle="modal" data-target="#analysis">Analiz</button>
                    </div>
                </div>
                <div class="same-big-box">
                    ...
                    <a href="cabinet-diagnosis.php" class="link-box">Bütün diaqnoz və müalicələrə bax</a>
                </div>
                <div class="same-big-box">
                    <p class="title-box">Analizlər</p>
                    <div class="img-box"><img src="img/dnt.png" alt=""></div>
                    <a href="cabinet-analysis.php" class="link-box">Bütün  diaqnozlara bax</a>
                </div>
            </div>
        </div>
    </div>
    ...
    ?>
    <!-- addModal -->
    <div class="modal fade addModal" id="diagnosis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <form>
                        ...
                        <div class="files-box">
                            ...
                            <label for="scanner1">
                                ...
                                <input type="file" name="" id="scanner1">
                            </label>
                        </div>
                        <label>
                            Əlavə notlar
    ...
    <!-- analysis -->
    <!-- addModal -->
    <div class="modal fade addModal" id="analysis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Diaqnoz yüklə</h5>
